...
- **Type**: Indicates the type of artefact (e.g., `OnnxOpset11`, `OnnxOpset16`, `TorchScriptV1`).
...
RT-DETRv2 person-detection capabilities use `OnnxOpset16` artefacts. If you are downloading model weights for a person detector, look for that artefact type in the list.
